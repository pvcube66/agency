    ...
    <footer className="bg-black border-t border-white/10 py-20">
      <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-2 gap-12 md:gap-24">
            <div>
              ...
              <ul className="space-y-4">
                <li><a href="#" className="text-white hover:text-white/70 transition-colors flex items-center gap-2"><Instagram size={16}/> Instagram</a></li>
                <li><a href="#" className="text-white hover:text-white/70 transition-colors flex items-center gap-2"><Twitter size={16}/> Twitter</a></li>
                <li><a href="#" className="text-white hover:text-white/70 transition-colors flex items-center gap-2"><Linkedin size={16}/> LinkedIn</a></li>
              </ul>
            </div>
            <div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-white/10 text-white/40 text-sm">
          <p>© 2024 Visuvate. All rights reserved.</p>
